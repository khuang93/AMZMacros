// STAR-CCM+ macro: TotPressCoeffz.java
...
public class TotPressCoeffz extends StarMacro {
  ...
  private void execute0() {
    ...
    coordinate_1.setValue(new DoubleVector(new double[] {0.0, 0.0, 1.0}));
    ...
    currentView_1.setInput(new DoubleVector(new double[] {-2.787116280822395, 1.2144714371218361, -0.05486798048512398}), new DoubleVector(new double[] {-2.787116280822395, 1.2144714371218361, 17.238133194441634}), new DoubleVector(new double[] {0.0, 1.0, 0.0}), 2.1165959559490695, 1);

  
    double z=0.00;
    for(int i=1; z<1.2;z=z+0.025){
     coordinate_0.setValue(new DoubleVector(new double[] {0.0, 0.0, 0.005+z}));
    scene_1.printAndWait(resolvePath(Path+getSimulation().getPresentationName()+"\\TPC_Z"+i+"_z="+(i)+".png"), 1, 1920, 1080);
    i=i+1;
   }
