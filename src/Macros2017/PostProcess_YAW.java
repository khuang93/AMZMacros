...
public class PostProcess_YAW extends StarMacro {
...
*/
    ...
    new StarScript(getActiveSimulation(),
                   ...
                   new java.io.File(resolvePath("Z:\\StarCCM\\Auto 2016\\Aero\\Macro\\2016\\PostProcess\\TotPressCoeffy_Yaw.java"))).play();
 /*
...
*/
	...
	new StarScript(getActiveSimulation(),
		...
		new java.io.File(resolvePath("Z:\\StarCCM\\Auto 2016\\Aero\\Macro\\2016\\PostProcess\\Surface_Pressure_Yaw.java"))).play();
      
      new StarScript(getActiveSimulation(),
                     
                     new java.io.File(resolvePath("Z:\\StarCCM\\Auto 2016\\Aero\\Macro\\2016\\PostProcess\\Plots_Yaw.java"))).play();
