...
public class Preprocessing_1Teil_fluela_Bootcamp_2Elements_HB extends StarMacro {
...
*/
    ...
    MeshPart meshPart_32 = 
      ...
      ((MeshPart) simulation_0.get(SimulationPartManager.class).getPart("ContactP_FT_HB"));
      
      MeshPart meshPart_34 =
      ((MeshPart) simulation_0.get(SimulationPartManager.class).getPart("ContactP_RT_HB"));
