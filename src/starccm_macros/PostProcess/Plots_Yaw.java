...
import java.io.File;
import star.flow.*; public class Plots_Yaw extends StarMacro {
...
/*
	...
	*/
    ...
    axisLabels_1.setMin(-15.0);
    
    axisLabels_1.setMax(-5.0);
    ...
    axisLabels_2.setMin(-130.0);
    
    axisLabels_2.setMax(-90.0);
    ...
    axisLabels_3.setMin(-50.0);
    
    axisLabels_3.setMax(-20.0);
    ...
    axisLabels_5.setMin(-80.0);
    
    axisLabels_5.setMax(-50.0);
    ...
    axisLabels_6.setMin(-220.0);

    axisLabels_6.setMax(-180.0);
    ...
    axisLabels_7.setMin(-120.0);
    
    axisLabels_7.setMax(-70.0);
    ...
    axisLabels_8.setMin(-120.0);
    
    axisLabels_8.setMax(-70.0);
    ...
    axisLabels_9.setMin(-220.0);
    
    axisLabels_9.setMax(-160.0);
